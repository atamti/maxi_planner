...
describe("useFormState", () => {
  ...
  describe("Transformer functionality", () => {
    it("should apply transformer to initial value", () => {
      ...
      const { result } = renderHook(() => useFormState("hello", undefined, transformer));
    ...
    it("should apply transformer when updating value", () => {
      ...
      const { result } = renderHook(() => useFormState("", undefined, transformer));
    ...
    it("should handle transformer with complex logic", () => {
      ...
      const { result } = renderHook(() => useFormState(50, undefined, transformer));
  ...
  describe("Combined transformer and validator", () => {
    it("should apply transformer before validation", () => {
      ...
      const { result } = renderHook(() => useFormState("", validator, transformer));
    ...
    it("should validate transformed initial value", () => {
      ...
      const { result } = renderHook(() => useFormState("hello", validator, transformer));
    ...
    it("should handle complex validation with transformation", () => {
      ...
      const validator = (value: number) => ({
        ...
        error: value < 0 || value > 100 ? "Must be between 0 and 100" : undefined,
      });
      
      const { result } = renderHook(() => useFormState(50.7, validator, transformer));
  ...
  describe("Performance and stability", () => {
    ...
    it("should memoize validation results", () => {
      ...
      const { result, rerender } = renderHook(() => useFormState("test", validator));
  ...
  describe("Type safety", () => {
    it("should maintain type safety with generic types", () => {
      ...
      const { result } = renderHook(() => useFormState<TestObject>({ id: 1, name: "test" }));
