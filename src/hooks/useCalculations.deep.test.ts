...
describe("useCalculations - Deep Validation", () => {
  ...
  describe('BTC Stack Calculations', () => {
    it('should maintain correct BTC allocation without growth', () => {
      ...
      console.log('Year 0 BTC with income:', result.current.results[0]?.btcWithIncome);
      console.log('Year 0 BTC without income:', result.current.results[0]?.btcWithoutIncome);
  ...
  describe('Income Calculations', () => {
    it('should generate zero income with no income allocation', () => {
      ...
      console.log('USD Income with Leverage:', result.current.usdIncomeWithLeverage);
    ...
    it('should generate leveraged income only when income allocation > 0', () => {
      ...
      console.log('With 25% allocation - USD Income with Leverage:', result.current.usdIncomeWithLeverage);
